        ...
        <div class="container-fluid">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Edit Province</h6>
            </div>
            <div class="card-body">
              @if ($errors->any())
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="province_name" value="{{$province->province_name}}">
              </div>
              <div class="form-group">
