        ...
        <div class="container-fluid">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Add Booqers</h6>
            </div>
            <div class="card-body">
              @if ($errors->any())
              ...
              @endif
              <form method="POST" action="{{route('booqer.store')}}">
                @csrf
              ...
              <div class="form-group">
                <select name="city" id="city" class="form-control">
                  ...
                  <option value="{{$cityData->id}} {{$cityData->province_id}}">{{$cityData->city_name}}</option>
                  @endforeach
                </select>
              </div>
              <div class="form-group">
